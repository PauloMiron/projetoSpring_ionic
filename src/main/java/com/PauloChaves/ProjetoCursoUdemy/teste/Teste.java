...
public class Teste implements CommandLineRunner{
        ...
        public void run(String... args) throws Exception {
            ...
            Categoria cat6 = new Categoria(null, "Deocaracao");
            Categoria cat7 = new Categoria(null, "Perfumaria");
            Categoria cat8 = new Categoria(null, "Higiene");
            Categoria cat9 = new Categoria(null, "Infantil");
            Categoria cat10 = new Categoria(null, "Para sua beleza");
            ...
            categoriaRepository.saveAll(Arrays.asList(cat1,cat2,cat3,cat4,cat5,cat6,cat6,cat7,cat8,cat9,cat10));
